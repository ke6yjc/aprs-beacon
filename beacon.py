...
MY_CALLSIGN = 'CHANGE ME'
MMDVM_LOGS_PATH = '/mnt/ram0/'
...
class GpsPoller(threading.Thread):
  ...
  def gps_error(self):
      ...
      if DEBUG==True:
          ...
          print "No PUBX line detected from GPS, retrying in 3 seconds..."
  ...
  def run(self):
      try:
        ...
        while not self.stopped:
          ...
          if self.fix=='G3' or self.fix=='G2' or self.fix=='D3' or self.fix=='D2': # Do we have a GPS fix?
